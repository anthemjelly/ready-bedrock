...
scoreboard players set @s[hasitem={item=ate:p9050,location=slot.weapon.offhand}] p90 50
...
scoreboard players set @s[hasitem={item=ate:p9050_ss190,location=slot.weapon.offhand}] p90 50
...
scoreboard players set @s[hasitem={item=ate:p9050_ss198,location=slot.weapon.offhand}] p90 50
...
scoreboard players set @s[hasitem={item=ate:p9050_r37f,location=slot.weapon.offhand}] p90 50
...
title @s[scores={p90=0}] actionbar §4未找到可用弹匣
tag @s[scores={p90=1..999}] add allowReload