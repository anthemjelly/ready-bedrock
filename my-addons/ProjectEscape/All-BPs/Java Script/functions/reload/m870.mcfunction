...
scoreboard players set @s[hasitem={item=ate:ammo1270,location=slot.weapon.offhand}] m870 5
...
scoreboard players set @s[hasitem={item=ate:ammo1270_ap20,location=slot.weapon.offhand}] m870 5
...
scoreboard players set @s[hasitem={item=ate:ammo1270_j,location=slot.weapon.offhand}] m870 5
clear @s[hasitem={item=ate:ammo1270_j,location=slot.weapon.offhand}] ate:ammo1270_j 0 1

title @s[scores={m870=0}] actionbar §4未找到可用弹匣
title @s[scores={m870=1..999}] actionbar §a装填完成
tag @s[scores={m870=1..999}] add allowReload