...
scoreboard players set @s[hasitem={item=ate:p9050,location=slot.weapon.offhand}] ar57 50
...
scoreboard players set @s[hasitem={item=ate:p9050_ss190,location=slot.weapon.offhand}] ar57 50
...
scoreboard players set @s[hasitem={item=ate:p9050_ss198,location=slot.weapon.offhand}] ar57 50
...
scoreboard players set @s[hasitem={item=ate:p9050_r37f,location=slot.weapon.offhand}] ar57 50
...
title @s[scores={ar57=0}] actionbar §4未找到可用弹匣
tag @s[scores={ar57=1..999}] add allowReload