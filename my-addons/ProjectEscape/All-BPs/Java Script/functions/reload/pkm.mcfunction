...
scoreboard players set @s[hasitem={item=ate:pkm100,location=slot.weapon.offhand}] pkm 100
...
scoreboard players set @s[hasitem={item=ate:pkm100_7bt1,location=slot.weapon.offhand}] pkm 100
...
scoreboard players set @s[hasitem={item=ate:pkm100_7n1,location=slot.weapon.offhand}] pkm 100
...
scoreboard players set @s[hasitem={item=ate:pkm100_7n37,location=slot.weapon.offhand}] pkm 100
...
scoreboard players set @s[hasitem={item=ate:pkm100_fmj,location=slot.weapon.offhand}] pkm 100
...
scoreboard players set @s[hasitem={item=ate:pkm100_snb,location=slot.weapon.offhand}] pkm 100
...
title @s[scores={pkm=0}] actionbar §4未找到可用弹匣
tag @s[scores={pkm=1..999}] add allowReload