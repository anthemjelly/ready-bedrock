...
scoreboard players set @s[hasitem={item=ate:rpd100,location=slot.weapon.offhand}] rpdn 100
...
scoreboard players set @s[hasitem={item=ate:rpd100_ap,location=slot.weapon.offhand}] rpdn 100
...
scoreboard players set @s[hasitem={item=ate:rpd100_bp,location=slot.weapon.offhand}] rpdn 100
...
scoreboard players set @s[hasitem={item=ate:rpd100_ps,location=slot.weapon.offhand}] rpdn 100
...
title @s[scores={rpdn=0}] actionbar §4未找到可用弹匣
tag @s[scores={rpdn=1..999}] add allowReload